...
# Fallback for slugs that have no entry above (most map pages). The whole site
# is regenerated by weekly.yml, so those pages say "weekly" too; the landing
# page keeps its own entry above because it also fronts live client-side pages.
_OG_FALLBACK = (
    "Austin 311",
